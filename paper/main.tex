...
LR convergence is fixed for seed 42 with \texttt{max\_iter=2000}. Older seed 7 and seed 99 LR rows still contain warnings from \texttt{max\_iter=500}. Final LR multi-seed tables should use convergence-clean reruns or explicitly report this limitation.
