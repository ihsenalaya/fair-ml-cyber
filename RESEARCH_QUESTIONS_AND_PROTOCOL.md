...
Les runs `fullcore-mem-s42-001`, `fullcore-mem-s7-001` et `fullcore-mem-s99-001` confirment RQ1/RQ2 sur le dataset complet pour le protocole core binaire:

- HistGradientBoosting passe en moyenne de 0.9977 macro-F1 en random split à 0.2315 en temporal et 0.4090 en day-holdout;
- LogisticRegression passe en moyenne de 0.9357 macro-F1 en random split à 0.5401 en temporal et 0.6394 en day-holdout;
