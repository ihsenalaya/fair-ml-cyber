...
- les runs full-data core `fullcore-mem-s42-001`, `fullcore-mem-s7-001` et `fullcore-mem-s99-001` sont termines sur les 2,438,052 lignes, chacun avec 20/20 runs completes et 0 echec;
- les resultats confirment sur trois seeds une forte rupture entre `random_stratified` et les stress-tests temporel/day/scenario;
